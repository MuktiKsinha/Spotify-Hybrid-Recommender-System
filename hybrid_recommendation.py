...
class HybridRecommenderSystem:
    ...
    def __weighted_combination(self,content_based_score,collaborative_based_score):
        weighted_score = (self.weight_content_based*content_based_score) + (self.weight_collaborative*collaborative_based_score)
        return weighted_score
    

    def give_recommendations(self,song_name, artist_name, songs_data, track_ids, transformed_matrix, interaction_matrix):
        #calcuate content based similarities
        ...
        #calculate colabborative based similarities
        ...
        #normalize the content based similarities
        ...
        weighted_scores = self.__weighted_combination(content_based_score=normalized_content_based_similarities,
                                                   collaborative_based_score=normalized_collaborative_filtering_similarities)
