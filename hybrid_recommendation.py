...
class HybridRecommenderSystem:
    ...
    def weighted_combination(self,content_based_score,collaborative_based_score):
    ...
    def give_recommendations(self):
        ...
        weighted_scores = self.weighted_combination(content_based_score=normalized_content_based_similarities,
